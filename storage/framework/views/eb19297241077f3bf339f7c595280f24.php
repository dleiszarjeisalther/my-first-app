...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="w-full border p-2 rounded" placeholder="e.g. Laravel" required>
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700">Mastery (%)</label>
                        <input type="number" name="percent" value="<?php echo e(old('percent')); ?>" class="w-full border p-2 rounded" placeholder="e.g. 85" required>
                    </div>
                    <div class="mb-4">
