{{--
    ...
    WHAT IT IS:
        ...
        It serves as the first point of entry for visitors.

    FEATURES:
        - Dynamic Login/Register links (via @auth directive)
        - Basic Laravel documentation & ecosystem links
        - Responsive layout using Tailwind CSS utility classes

    HOW IT WORKS:
        - Uses @auth to check if the user is logged in:
          - If logged in → shows "Dashboard" link
          - If guest → shows "Log in" and optional "Register" links
        - Styles are primarily inline or pulled from @vite assets
          if the build directory exists.

    HOW TO CUSTOMIZE:
        1. Routing: Modify routes/web.php (maps / to this view)
        2. UI: This file uses pure Tailwind. Change background colors
           in line 25, or swap the logo in lines 31-34.
    ============================================================
--}}
<!DOCTYPE html>
    ...
    <head>
        ...
        @else
            <style>
                ...
                /* ... (Truncated Tailwind CSS for brevity, but I will include enough for the layout) */
